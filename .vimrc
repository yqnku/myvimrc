...
func SetTitle() 
    ...
    if &filetype == 'sh' 
        ...
        call append(line(".")+2, "\# Author: yqnku") 
        call append(line(".")+3, "\# mail: xiqian013@live.com") 
	...
	if &filetype == 'python' 
        ...
        call append(line(".")+4, "\# Author: yqnku") 
        call append(line(".")+5, "\# Mail: xiqian013@live.com ") 
    ...
    if &filetype == 'cpp'
        ...
        call append(line(".")+1, "    > Author: yqnku") 
        call append(line(".")+2, "    > Mail: xiqian013@live.com ") 
    ...
    if &filetype == 'plaintex'
        ...
        call append(line(".")+7, "\\usepackage{geometry}")
        call append(line(".")+8, "\\geometry{left=2.5cm,right=2.5cm,top=2.5cm,bottom=2.5cm}")
        call append(line(".")+9, "\\usepackage{hyperref}")
        call append(line(".")+10, "\\begin{document}")
        call append(line(".")+11, "    \\pagestyle{plain}")
        call append(line(".")+12, "\\end{document}")
    endif 
    "如果文件类型为.txt文件
    if &filetype == 'text'
        call setline(1, "/*************************************************************************") 
